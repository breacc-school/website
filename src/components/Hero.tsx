...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container text-center px-4" style={{ textShadow: '0 2px 12px rgba(0,0,0,0.5)' }}>
        <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-black text-primary-foreground mb-6 animate-fade-in-up drop-shadow-lg">
          Bem-vindos ao BREACC
        </h1>
        <p className="text-xl md:text-2xl text-primary-foreground max-w-2xl mx-auto mb-10 font-body opacity-0 animate-fade-in-up drop-shadow-md" style={{ animationDelay: "0.2s" }}>

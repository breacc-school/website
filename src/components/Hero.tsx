...
const translations = {
  pt: {
    heading: "Bem-vindos ao",
    subtitle: "Brazilian Educational and Cultural Centre — Preservando a língua e cultura brasileira no Reino Unido desde 1998.",
    ctaGroups: "Conheça nossos grupos",
    ctaVisit: "Agende uma visita",
    altCarnival: "Festa de carnaval do BREACC com bandeira do Brasil",
    altTeam: "Equipe do BREACC com camisetas verdes",
    altFlags: "Artesanato com bandeiras do Brasil",
  },
  en: {
    heading: "Welcome to",
    subtitle: "Brazilian Educational and Cultural Centre — Preserving Brazilian language and culture in the United Kingdom since 1998.",
    ctaGroups: "Discover our groups",
    ctaVisit: "Book a visit",
    altCarnival: "BREACC carnival celebration with Brazilian flag",
    altTeam: "BREACC team wearing green shirts",
    altFlags: "Crafts with Brazilian flags",
  },
};
      ...
      <div className="container px-6 py-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="flex-1 z-10 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <a
              href="#groups"
              onClick={(e) => scrollToSection(e, "groups")}
